                  ...
                  <CardContent className="p-8">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                      ...
                      <div className="flex items-center gap-6">
                         ...
                         <Button variant="ghost" size="icon" className="text-slate-300 group-hover:text-primary transition-all group-hover:translate-x-1">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                           <button
                             ...
                             className={`p-6 rounded-xl border-2 flex flex-col items-center gap-3 transition-all ${
                               formData.apiKeyProvider === "openai" 
                           ...
                           <button
                             ...
                             className={`p-6 rounded-xl border-2 flex flex-col items-center gap-3 transition-all ${
                               formData.apiKeyProvider === "google" 
                               ? "border-primary bg-primary/5 shadow-md" 
                               : "border-slate-100 hover:border-slate-200"
                             }`}
                           >
